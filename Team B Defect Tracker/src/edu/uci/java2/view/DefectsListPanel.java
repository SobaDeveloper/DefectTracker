 ...
 * Purpose: Display list of defects for a given application
 * 
...
public class DefectsListPanel extends JPanel implements ItemListener {
	...
	/**
	 * Get the defect lists table
	 * @return return the defect lists table
	 */
	...
	/**
	 * Call when screen is displayed to refresh the DB
	 */
	public void refresh()
	{
...
//		this.repaint();
	...
	/**
	 * Application JComboBox itemlistener. Updates table for a
	 * given application.
	 */
	@Override
